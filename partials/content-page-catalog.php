...
<section class="network-catalog">
	<form role="form" class="filter-sort" method="get">
		...
		<fieldset class="subject-filters">
			<h2><?php esc_html_e( 'Filter by Subject', 'pressbooks-aldine' ); ?></h2>
			<input type="radio" name="subject" id="all-subjects" value="" <?php checked( $subject, '' ); ?>>
			<label for="all-subjects"><?php esc_html_e( 'All Subjects', 'pressbooks-aldine' ); ?> <svg class="checked"><use xlink:href="#checkmark" /></svg></label>
		...
		<fieldset class="institution-filters">
			<h2><?php esc_html_e( 'Filter by Institution', 'pressbooks-aldine' ); ?></h2>
			<input type="radio" name="institution" id="all-institutions" value="" <?php checked( $institution, '' ); ?>>
			<label for="all-institutions"><?php esc_html_e( 'All Institutions', 'pressbooks-aldine' ); ?> <svg class="checked"><use xlink:href="#checkmark" /></svg></label>
			<?php
		...
		<fieldset class="license-filters">
			<h2><?php esc_html_e( 'Filter by License', 'pressbooks-aldine' ); ?></h2>
			<input type="radio" name="license" id="all-licenses" value="" <?php checked( $license, '' ); ?>>
			<label for="all-licenses"><?php esc_html_e( 'All Licenses', 'pressbooks-aldine' ); ?> <svg class="checked"><use xlink:href="#checkmark" /></svg></label>
			<?php
		...
		<fieldset class="sorts">
			<h2><?php esc_html_e( 'Sort by', 'pressbooks-aldine' ); ?></h2>
			<?php
			$sorts = [
				'title' => esc_html__( 'Title', 'pressbooks-aldine' ),
				'subject' => esc_html__( 'Subject', 'pressbooks-aldine' ),
				'latest' => esc_html__( 'Latest', 'pressbooks-aldine' ),
			];
		...
		<button type="button" class="clear-filters" hidden><?php esc_html_e( 'Clear Filters', 'pressbooks-aldine' ); ?></button>
		<button type="submit"><?php esc_html_e( 'Submit', 'pressbooks-aldine' ); ?></button>
	</form>
<ul class="books">
	<?php
...
<nav class="catalog-navigation">
	...
	if ( $previous_page ) :
		?>
		<a class="previous" rel="previous" data-page="<?php echo $previous_page; ?>" href="<?php echo network_home_url( "/catalog/page/$previous_page/" ); ?>"><span class="screen-reader-text"><?php esc_html_e( 'Previous Page', 'pressbooks' ); ?></span>
	...
	if ( $next_page <= $catalog_data['pages'] ) :
		?>
		<a class="next" rel="next" data-page="<?php echo $next_page; ?>" href="<?php echo network_home_url( "/catalog/page/$next_page/" ); ?>"><span class="screen-reader-text"><?php esc_html_e( 'Next Page', 'pressbooks' ); ?></span>
			<svg aria-hidden="true">
