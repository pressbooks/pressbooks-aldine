...
class Actions
{
    ...
    public static function setup()
    {
        ...
        add_action('init', [self::class, 'registerShortcodeButtons']);
     ...
     * @return void
     */
    public static function outputCustomColors()
    {
     ...
     */
    public static function removeAdminBarCallback()
    {
     ...
     */
    public static function hideCatalogContentEditor()
    {
     ...
     * @since 1.0.0
     */
    public static function addColorVariants($option, $old_value, $value)
    {
     ...
     * @since 1.1.0
     */
    public static function registerShortcodeButtons()
    {
        ...
        add_filter('mce_external_plugins', [\Aldine\Filters::class, 'addButtons']);
        add_filter('mce_buttons', [\Aldine\Filters::class, 'registerButtons']);
    }
     ...
     * @since 1.1.0
     */
    public static function tinymceL18N()
    {
        ?>
