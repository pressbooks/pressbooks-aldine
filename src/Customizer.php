...
class Customizer
{
     ...
     */
    public static function ajaxSearchCatalogBooks(): void
    {
     ...
     */
    public static function customizeRegister(\WP_Customize_Manager $wp_customize)
    {
     ...
     */
    public static function customizePreviewJs()
    {
     ...
     * Binds JS handlers to make Theme Customizer preview reload changes asynchronously.
     */
    public static function featuredBooksScripts()
    {
        $assets = new Assets('pressbooks-aldine', AssetType::THEME);
     ...
     */
    public static function enqueueColorContrastValidator()
    {
     ...
     */
    public static function enqueueContactFormTweaks()
    {
        $assets = new Assets('pressbooks-aldine', AssetType::THEME);
     ...
     */
    public static function enqueuePbA11YInCustomizer()
    {
     ...
     */
    public static function enqueueCatalogSearchControlAssets(): void
    {
        $assets = new Assets('pressbooks-aldine', AssetType::THEME);
